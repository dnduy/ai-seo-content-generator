            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">Get your API key from <a href="https://openrouter.ai/" target="_blank">OpenRouter</a>. Supports DeepSeek Chat (V3/V4) and DeepSeek R1 (Reasoning). <em>(Encrypted in database)</em></p>
                    </td>
                </tr>
                <tr>
